...
def login():
    ...
    if username.get() == <mail> and password.get() == "":
...
def allega(labelFileScelto):
    ...
    allega.has_been_called_allega = True  # se sono entrato in questa funzione lo setto a true
...
def testoEmail(window, testoEntry):
    ...
    testoEmail.has_been_called_testo = True  # se sono entrato in questa funzione lo setto a true
    global inputTesto
